...
<div class="container-fluid">
	...
	<form action="" id="manage-user">	
		...
		<div class="form-group">
			...
			<input type="email" name="username" id="username" class="form-control" value="<?php echo isset($meta['username']) ? $meta['username']: '' ?>" required  autocomplete="off">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<select name="type" id="type" class="custom-select">
				<!-- <option value="2" <?php echo isset($meta['type']) && $meta['type'] == 2 ? 'selected': '' ?>>Docente</option> -->
